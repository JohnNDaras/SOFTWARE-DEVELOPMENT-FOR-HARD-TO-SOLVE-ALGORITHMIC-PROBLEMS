...
double local_transition(Tree &tree, Polygon_2 &polygon, Points &points, Point_2 &q, Point_2 &r, Points &points_to_check, int &L,  double &energy, float &R, string min_or_max)
{	
	int n = points.size();
    ...
    long int final_area = abs(final_polygon.area());  // proj3
    return (double)final_area/ch_area ;   // proj3
}
