...
/////////       NEW ADDITION        //////////////////////////
    ...
    for( Point_2 &P : pol_points)    // this replaces the initial triangle 
        polygon.push_back(P);           
    }

///////////////////////////////////

std::cout<<"starting polygon success \n";
if (polygon.is_clockwise_oriented())
        {polygon.reverse_orientation(); // every polygon will be counter-clockwise oriented
        std::cout<<"it is clockwise \n";}
std::cout<<"\n\n counter clock success \n";
/////////////////////////////////////////////////////////////    
