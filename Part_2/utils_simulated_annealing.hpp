...
Polygon_2 local_transition(Tree &tree, Polygon_2 &polygon,Points &points, Point_2 &p, Point_2 &q, Points &points_to_check, int &L, double &energy, float &R, string min_or_max);
