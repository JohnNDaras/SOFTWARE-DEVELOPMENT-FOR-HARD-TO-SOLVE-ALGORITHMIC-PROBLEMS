...
Segment_2 select_edge(Segments visible_edges, std::string selection, Point_2 p);
Polygon_2 incremental(Points points, std::string initialization, std::string edge_selection);//delete this